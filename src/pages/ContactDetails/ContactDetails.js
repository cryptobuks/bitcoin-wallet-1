    ...
    return (
      <div>
        <div className="details-btns">
          <Link to='/contact'><button className="action-btn"><i className="fa fa-arrow-left"></i></button></Link>
          <Link to={`/edit/${contact._id}`} className="contact-edit"><button className="action-btn"><i className="fa fa-pencil"></i></button></Link>
        </div>
